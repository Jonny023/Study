...
```sql
-- 添加多列
ALTER TABLE test.kpi ADD v1 int2, ADD v2 int2;

-- 不支持同时修改多列
alter table test.kpi rename column v1 to v2;
alter table test.kpi rename column v2 to v1;

-- 删除多列
alter table test.kpi drop column v1, drop v2;
```
