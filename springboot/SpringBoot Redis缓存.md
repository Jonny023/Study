...
import cn.com.geely.constaints.Const;
...
public class RedisUtil {
    ...
    public Boolean lock(String key) {
        String lock = Const.LOCK_PREFIX + key;
        return redisTemplate.opsForValue().setIfAbsent(lock, lock, Const.LOCK_EXPIRE, TimeUnit.MILLISECONDS);
    }
